// Простой скрипт для генерации SQL
const fs = require('fs');
...
console.log('✅ SQL файл создан: scripts/FINAL_SETUP.sql');
console.log('📝 Скопируйте содержимое и выполните в Supabase SQL Editor');
