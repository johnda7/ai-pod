...
export const TeenDashboard: React.FC<TeenDashboardProps> = ({ user: initialUser, onTaskComplete, onUserUpdate }) => {
  ...
  const renderContent = () => {
    ...
    if (activeTab === 'PROFILE') {
        ...
        return (
            <div className="px-5 pt-16 pb-32 min-h-screen relative" style={{ background: 'linear-gradient(180deg, #0a0a1a 0%, #0f0f2a 50%, #0a0a1a 100%)' }}>
    ...
    return (
        <div className="relative pt-2 pb-40 px-4 min-h-screen overflow-x-hidden">
             ...
             <div className="flex justify-between items-center mb-4 relative z-40 pt-14 sticky top-0 pb-3 -mx-4 px-4 transition-all duration-300">
                 {/* Glass background */}
                 <div 
