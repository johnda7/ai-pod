-- ============================================
-- АВТОМАТИЧЕСКИ СГЕНЕРИРОВАННЫЙ SQL СКРИПТ
...
-- 2. Исправление типа inventory (безопасно)
DO $$ 
BEGIN
  BEGIN
    ALTER TABLE users ALTER COLUMN inventory DROP DEFAULT;
  EXCEPTION WHEN OTHERS THEN 
    -- Если DEFAULT нет, продолжаем
    NULL;
  END;
END $$;

-- Конвертация text[] в jsonb
ALTER TABLE users 
