...
export const BossBattle: React.FC<BossBattleProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex flex-col">
      ...
      <button
        onClick={onClose}
        className="absolute top-6 right-4 z-20 w-10 h-10 rounded-full bg-white/10 backdrop-blur-xl flex items-center justify-center"
      >
        <X size={20} className="text-white/60" />
      </button>
      
      {/* Battle Arena */}
      <div className="relative z-10 flex-1 flex flex-col p-4 pt-8">
